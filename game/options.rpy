...
define gui.about = _p("""Проект по программированию студентов ФиКЛа Горбовой Наташи, Масленниковой Ани, Вишняговой Полины и Кузьмина Гриши

Отдельная благодарность Антону Бузанову за источник вдохновения
""")
...
define build.name = "mongolian_project"
...
define config.save_directory = "mongolian_project"
