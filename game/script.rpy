...
if is_dream >= 1:
        ...
        hide rat
        show rat_attack_anim
        pause 1.2  # 12 кадров * 0.1 секунды
        hide rat_attack_anim
        show rat
...
label crossword_imba:
    ...
    python:
        wordlist = [
            ['УРАГШ',   "__ и только __"],
            ["ОР", "помогает пропустить ночь в майнкрафте"],
            ["САНДАЛ", "что при лучшем качестве могло бы спасти Ахиллеса"],
            ["ХАРХ", "серое адгуус с розовым хвостом"],
            ["ТАХИА", "несут өндөг"],
            ["УНЭЭ", "далеко далеко на лугу пасется"],
            ["МУУР", "издают звуки созвучные их названию"],
            ["СУУ", "үнээ производит этот продукт"],
            ["ТАЛХ", "__ да соль"],
            ["ОНДОГ", "то, что несут тахиа"],
        ]
